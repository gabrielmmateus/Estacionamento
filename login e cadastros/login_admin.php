...
<head>
  ...
  <title>DREAM PARKING - LOGIN</title>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #FAA510;">
    <div class="container-fluid">
      ...
      <form action="" method="post" class="nav justify-content-end col-12">
          ...
          <a class="nav-link text-md-center"  href="../index.html" style="color: #FFF; background-color: #FAA510; font-weight: bold; margin-left: 90px; border-style: none;" id="login_button">Voltar</a>
          </li>
        </form>
      </div>
    </div>
          ...
          <div  class="card  text-warning" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              ...
              <div class="mb-md-1 mt-md-1 pb-1">
                ...
                <h2 class="fw-bold mb-2 ">LOGIN</h2><br><br>
                <?php
                ...
                <form action="proc_login_admin.php" method="post">
                  ...
                  <br><br><br><button style=" border-color: #FAA530; background-color: #FAA510;" class="btn btn-outline-light btn-lg px-5" type="submit">Login</button>
                </form>
  ...
  <div id="footer">
    ...
    <footer style="background-color: #FAA510;" class="d-flex flex-wrap justify-content-between align-items-center py-3  border-top" id="rodape">
      ...
      <ul class="nav col-mc-4 justify-content-end">
        <li class="nav-item"><a href="login_admin.php" class="nav-link px-2" id="home" style="font-size: 14px; color: #FFF;">Início</a></li>
