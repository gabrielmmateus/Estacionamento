<?php
    ...
    include_once("conexao.php"); //incluindo no banco

    //pegando dados e fazendo verificação
    ...
    //VERRIFICANDO SE A PLACA É UNICA
    ...
    if ($quantidade <= 200 && $unica_placa){
        ...
        if (preg_match($rgx, $placa) == 1) {
            ...
            if (mysqli_insert_id($conn)) {
                ...
                header("Location: ../listar_automovel/index.php");
            } else {
