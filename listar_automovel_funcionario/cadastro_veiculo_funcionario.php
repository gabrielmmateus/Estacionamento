...
<body id="body">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #FAA510;">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="../index.html" id="nome">DREAM PARKING</a>
      ...
      <div class="collapse navbar-collapse col-5" id="mynavbar">
        <form action="" method="post" class="nav justify-content-end col-12">
          <li class="nav justify-content-end col-12">
            <a class="nav-link text-md-center"  href="../listar_automovel_funcionario/index.php" style="color: #FFF; background-color: #FAA510; font-weight: bold; margin-left: 90px; border-style: none;" id="login_button">Voltar</a>
          </li>
        </form>
      </div>
    </div>
          ...
          <div  class="card  text-warning" style="border-radius: 1rem; ">
            <div class="card-body p-5 text-center">
              ...
              <div class="mb-md-5 mt-md-4 pb-5">
                ...
                <h2 class="fw-bold mb-2 ">CADASTRO - VEÍCULO</h2><br><br>
                <?php
                ...
                ?>
                <!-- CADASTRO DA PLACA -->
                <form action="proc_cadastro_veiculo_funcionario.php" method="post">
                  <div class="form-outline form-white mb-4">
                    <label  for="placa">Placa do veículo</label>
                    <input type="text" id="placa" name="placa" class="form-control form-control-lg" placeholder="Insira a placa do veículo" max="7" required/>
                  </div>
  ...
  <div id="footer">
    ...
    <footer style="background-color: #FAA510;" class="d-flex flex-wrap justify-content-between align-items-center py-3  border-top" id="rodape">
      ...
      <ul class="nav col-mc-4 justify-content-end">
        <li class="nav-item"><a href="cadastro_veiculo_funcionario.php" class="nav-link px-2" id="home" style="font-size: 14px; color: #FFF;">Início</a></li>
